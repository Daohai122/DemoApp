...
function TonKhoScreen({ navigation, route } ) {
  console.log('route.params.tab', route)
  ...
  return (
    <View style={{ flex: 1 }}>
      <Header
        ...
        IconLeft={route.params?.tab? null : { name: "arrow-back", type: "Ionicons" }}
        title={"Hàng hóa trong kho"}
        NoNavHeader={route.params?.tab ?? false}
      />
